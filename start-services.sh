...
# Waste Marketplace - Service Startup Script
echo "🚀 Starting Waste Marketplace Services..."
...
psql -d waste_marketplace -f services/marketplace-service/create_marketplace_tables.sql > /dev/null 2>&1
