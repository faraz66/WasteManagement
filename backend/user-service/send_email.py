#!/usr/bin/env python3
"""
Email Sender Script for EcoWaste
...
def send_password_reset_email(recipient_email, reset_url, user_name="User"):
    ...
    try:
        ...
        msg['From'] = f"EcoWaste Team <{USERNAME}>"
        msg['To'] = recipient_email
        msg['Subject'] = "🔐 Reset Your EcoWaste Password - Action Required"
...
<body>
    <div class="email-container">
        ...
        <div class="footer">
            <p class="company-name">EcoWaste Team</p>
        ...
        # Plain text version
        text_content = f"""
EcoWaste Password Reset

Hello {user_name},

Someone requested a password reset for your EcoWaste account. If this was you, use the link below to reset your password:
